...
SECRET_KEY = 'wn&!gk!3d-km=swud1x5ur)0za1x#7#if(i^feq3!oqh_y=ll='
...
DATABASES = {
    'default': {
        ...
        'NAME': 'django-db',  # DB name
        'USER': 'django',  # DB account
        'PASSWORD': 'django',  # DB account's password
        # 'HOST': '127.0.0.1',  # DB address(IP)
        # 'PORT': '3306',  # DB port(normally 3306)
        'HOST': 'db',  # DB address(IP)
        'PORT': '3306',  # DB port(normally 3306)
    }
}
